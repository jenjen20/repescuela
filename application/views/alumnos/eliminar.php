	...
	<div class="container">
		<div class="span10 of-set1">
			...
			<form action="" method="post" class="form-horizontal">
				...
				<p class="alert alert-error">¡Estás seguro de eliminar a <?php echo $objAlumno->nombre.' '.$objAlumno->apellidos; ?> ?</p>
				<div class="form-action">
					<button type="submit" class="btn btn-danger">Si</button>
					<a href="<?php echo base_url('alumnoscontroller/index'); ?>" class="btn btn-success">No</a>
				</div>
			</form>
		</div>
	</div>
